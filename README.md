...
curl -L -o npmguard.tar.gz \
  https://github.com/AyoubTadlaoui/npmguard/releases/latest/download/npmguard-v0.1.7-aarch64-apple-darwin.tar.gz
tar -xzf npmguard.tar.gz
# Edit the directory name below if the version has changed.
sudo mv npmguard-v0.1.7-aarch64-apple-darwin/npmguard-cli  /usr/local/bin/npmguard
sudo mv npmguard-v0.1.7-aarch64-apple-darwin/npmguard-mcp  /usr/local/bin/npmguard-mcp
```
...
```bash
curl -L -o npmguard.tar.gz \
  https://github.com/AyoubTadlaoui/npmguard/releases/latest/download/npmguard-v0.1.7-x86_64-apple-darwin.tar.gz
tar -xzf npmguard.tar.gz
# Edit the directory name below if the version has changed.
sudo mv npmguard-v0.1.7-x86_64-apple-darwin/npmguard-cli  /usr/local/bin/npmguard
sudo mv npmguard-v0.1.7-x86_64-apple-darwin/npmguard-mcp  /usr/local/bin/npmguard-mcp
```
...
```bash
curl -L -o npmguard.tar.gz \
  https://github.com/AyoubTadlaoui/npmguard/releases/latest/download/npmguard-v0.1.7-x86_64-unknown-linux-gnu.tar.gz
tar -xzf npmguard.tar.gz
# Edit the directory name below if the version has changed.
sudo mv npmguard-v0.1.7-x86_64-unknown-linux-gnu/npmguard-cli  /usr/local/bin/npmguard
sudo mv npmguard-v0.1.7-x86_64-unknown-linux-gnu/npmguard-mcp  /usr/local/bin/npmguard-mcp
```
...
```bash
curl -L -o npmguard.tar.gz \
  https://github.com/AyoubTadlaoui/npmguard/releases/latest/download/npmguard-v0.1.7-aarch64-unknown-linux-gnu.tar.gz
tar -xzf npmguard.tar.gz
# Edit the directory name below if the version has changed.
sudo mv npmguard-v0.1.7-aarch64-unknown-linux-gnu/npmguard-cli  /usr/local/bin/npmguard
sudo mv npmguard-v0.1.7-aarch64-unknown-linux-gnu/npmguard-mcp  /usr/local/bin/npmguard-mcp
```
...
```
https://github.com/AyoubTadlaoui/npmguard/releases/latest/download/npmguard-v0.1.7-x86_64-pc-windows-msvc.zip
```
...
shasum -a 256 -c <(grep npmguard-v0.1.7-aarch64-apple-darwin.tar.gz SHA256SUMS.txt)
```
